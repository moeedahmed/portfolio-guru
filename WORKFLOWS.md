...
| ---------------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `success`              | `✅ *Case filed*` + `{form_name} saved as a Kaizen draft.` subhead                        | SLO/date summary, field count, usage line, optional one-line `💡 {observation}`                                                                                                  | `🔁 Same case, another WPBA` (when applicable) / `📋 File another case` / `👍 It worked` · `👎 Didn't work` (+ `✏️ Amend this draft` appended to first row) |
