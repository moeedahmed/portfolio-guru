...
| ----------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Clinical case content sent for extraction | «REVIEW: define. The most privacy-protective option is to delete raw case content once the Kaizen draft is saved / the session ends, retaining only what is needed for the user's own history. State the actual implemented behaviour — do not over-promise deletion that the code does not perform.» |
