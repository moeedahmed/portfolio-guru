...
export PORTFOLIO_GURU_EXTRACTOR_PROVIDER="${PORTFOLIO_GURU_EXTRACTOR_PROVIDER:-gemini-3.5-flash}"
echo "Gemini models: fast=$GEMINI_FAST_MODEL stable=$GEMINI_STABLE_MODEL extractor=$PORTFOLIO_GURU_EXTRACTOR_PROVIDER"
