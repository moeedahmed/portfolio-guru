...
# Maps our schema field keys to Kaizen DOM element IDs.
# "common" fields appear across many forms (same DOM id).
# Per-form overrides in FORM_FIELD_MAP.

COMMON_FIELDS = {
    "date_of_encounter":    "startDate",           # date (d/m/yyyy)
    "date_of_event":        "5391f8de-de63-4db3-9e08-baaa2a380cfe",  # date
    "stage_of_training":    "e0864e88-62cf-43aa-a9e5-51abd98a1cce",  # select
    "clinical_reasoning":   "60772a97-92eb-4dbe-a813-6a5293be82f9",  # textarea (CBD: "Case to be discussed")
    "case_observed":        "60772a97-92eb-4dbe-a813-6a5293be82f9",  # same id, different label
    "cases_observed":       "60772a97-92eb-4dbe-a813-6a5293be82f9",  # ACAT variant
    "reflection":           "610b5c60-99ac-4902-9407-22974d6a5799",  # textarea
    "placement":            "286d64f5-2aa0-41eb-aba6-a7bc523f133c",  # select
    "clinical_setting":     "f091f9c5-6c77-48be-9b96-05ebe1b56a07",  # select (Mini-CEX)
    "clinical_setting_acat":"e1ae9b5b-85b2-45e4-9c1f-f322c7a6dc31",  # select (ACAT)
    "description":          "event-description",   # optional textarea
}
...
FORM_FIELD_MAP = {
    ...
    "LAT": {
        "date_of_encounter":      "startDate",
        "date":                   "ebccdd92-bfac-44b4-abde-d7958118ff05",
        "trainee_post":           "b4b62e33-3359-4504-9877-17f2e38e9fd0",
        "leadership_priorities":  "325c4423-ff20-4667-918b-c2f2a323acd0",
        "description_of_event":   "4c88f4f8-32bb-43c6-905b-411b7915affd",
    },
    "ACAF": {
        "date_of_encounter": "startDate",
        "situation":         "4ea8380a-86dc-4483-926e-c0deb4a7e021",
        "population":        "eaaffbe3-1bbe-4600-92ec-ecad6d6483bb",
        "intervention":      "66ce86c5-086c-485c-a46b-76e259ee3f77",
        "comparison":        "3f2ca5b6-b65e-48b2-b2e4-53130ce2951d",
        "outcome":           "b1013e86-5e07-47e0-ac01-ecc332601b8c",
        "other":             "0e54dd77-dcae-449d-9d90-3f2b345b42ef",
        "search_methodology":"e68164a5-435e-472f-a2d3-5880eb5eae14",
        "evidence_evaluation":"ae5f23c6-3ea1-4836-b1f4-db664f6d5d95",
        "application":       "a277f5d6-9d68-4408-ac45-20ccc97dd746",
        "patient_communication":"eda3bc11-3115-475e-93ba-5f186f6f2ecc",
        "future_research":   "8fb576f7-aa62-496d-ac40-0cc5d7e9649e",
        "reflection":        "e5b279ff-63fc-46cf-a0a0-c87c8dfcc78b",
    },
    "STAT": {
        "date_of_encounter": "startDate",
        "date":              "9d48100e-9647-4c67-8d39-24bbe8e5e3fa",
        "stage_of_training": "e0864e88-62cf-43aa-a9e5-51abd98a1cce",
    ...
    "MSF": {
        "date_of_encounter": "startDate",
        "date":              "b699e57a-6f7d-463e-a5a3-f78c2bdbe50c",
        # MSF is primarily filled by the assessor — trainee only sets the date
    },
    "JCF": {
        "date_of_encounter": "startDate",
        "date":              "9d48100e-9647-4c67-8d39-24bbe8e5e3fa",
    ...
    "QIAT": {
        ...
        "qi_pdp":             "99bfcd58-1cc3-4f79-9832-32c9d315e1a5",
        "qi_involvement":     "fd738d73-9b88-4bfb-8c67-a7d7a0defa57",
        "qi_learning":        "dab68d71-46ca-46a6-97e8-e2f2a6b29a82",
        "qi_project_involved":"2e2096f3-f65e-465c-bdd6-effadbe743dc",
        "qi_reflections":     "8a8f2bce-26fa-4baa-81d3-5b567ce9d45c",
        "qi_next_year":       "09a89221-ab2c-42f6-8462-1333540f8cf8",
    },
    "TEACH": {
        "date_of_encounter":  "startDate",
        "date_of_activity":   "e90d9f84-68fc-4dbf-a8be-977180ffc2cb",
        "session_title":      "6b62a9ef-b0bf-498c-b10b-410fa97766c3",
        "recognised_course":  "17d7899f-0564-4e51-9817-54444e43822c",
    ...
    "US_CASE": {
        ...
        "how_us_used":        "05d2c806-ef77-49f1-b582-61e6dff50273",
        ...
        "what_learned":       "df24a5de-14a4-4d25-9c93-b93ac76991b9",
    ...
    "ESLE": {
        ...
        "done_differently":    "be609110-389a-4411-969e-ee4289f691ed",
        "why":                 "761354f7-908a-4101-b7d8-66d324a62658",
        "different_outcome":   "5998869f-feb1-4cc4-865c-19ac975b7e0e",
        "future_changes":      "54bb61c4-dc39-4e56-9e22-b1acd21edabb",
        "what_learned":        "0a463c2f-f443-45b7-bd21-eb7c77b4e3f2",
    ...
    "COMPLAINT": {
        ...
        "care_given":          "6dee7933-3979-4c13-afc7-914f1514c8e7",
    ...
    "SERIOUS_INC": {
        ...
        "case_description":    "a4feee19-b600-4c42-a286-15a81f8835c2",
    ...
    "EDU_ACT": {
        ...
        "education_title":     "772f10f2-f292-4bc8-b349-bd6fff6679b7",
...
async def _save_draft(page: Page) -> bool:
    """Click Save/Save Draft button. Never Submit. Returns True on success."""
    # Look for save buttons — prefer "Save as Draft" or "Save Draft"
    save_selectors = [
    ...
    for selector in save_selectors:
        try:
            ...
            if await btn.count() > 0:
                ...
                if any(danger in btn_text.lower() for danger in ["submit", "send"]):
                    logger.warning(f"BLOCKED dangerous button: '{btn_text}'")
                    continue
                await btn.click()
                await asyncio.sleep(3)
                logger.info(f"Clicked save button: '{btn_text}'")
                return True
        except Exception:
            continue
