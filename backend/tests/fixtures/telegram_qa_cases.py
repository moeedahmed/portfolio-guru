"""Six golden offline-QA cases for Haris (ACCS/Intermediate) and Sana (SAS).
...
Each case drives the bot through case-text → form-recommendation → form-tap
and captures the draft preview produced from the offline patched extractor.
"""
