    ...
    "LAT": {
        ...
        "fields": [
            ...
            {"key": "leadership_context",   "label": "Leadership Context",      "type": "text",     "required": True,
             "description": "Describe the context of this specific leadership scenario: the clinical environment, team composition, pressures, time constraints, and your leadership role. Extract from the case — do not invent annual training priorities or personal development goals. Leave blank only if the case provides no situational context at all."},
            {"key": "stage_of_training",    "label": "Stage of Training",       "type": "dropdown", "required": True,
             "options": ["Intermediate/ST3", "Higher/ST4-ST6", "PEM Sub-specialty", "ACCS ST1-ST2/CT1-CT2"]},
    ...
    "REFLECT_LOG": {
        ...
        "fields": [
            ...
            {"key": "event_type",         "label": "Type of event/circumstances",     "type": "dropdown", "required": False,
             "options": ["ED patient", "CDU patient", "Clinic patient", "Anaesthetic list", "ITU", "Ward patient", "Pre-hospital"]},
